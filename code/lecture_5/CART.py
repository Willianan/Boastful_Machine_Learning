...
tree_CART = DecisionTreeClassifier()
tree_CART.fit(x,y)
print(tree_CART)


# 预测与评估
y_pred = tree_CART.predict(x)
print(y_pred)
...
target_names = ['0','1']
dot_data = StringIO()
tree.export_graphviz(tree_CART,out_file=dot_data,feature_names=feature_names,class_names=target_names,
